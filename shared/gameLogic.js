...
/**
 * Calculate total resources for a player, optimized for hot paths
 * Avoids Object.values().reduce() which causes array allocations
 * @param {Object} resources - A player's resources object
 * @returns {number} The total count of resources
 */
