 ...
 * Optimized for performance in hot paths (avoiding Object.values overhead).
 */
export function getTotalResources(res) {
  if (!res) return 0;
  return (res.brick || 0) + (res.lumber || 0) + (res.wool || 0) + (res.grain || 0) + (res.ore || 0);
}
