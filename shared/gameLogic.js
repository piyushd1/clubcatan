...
/**
 * Calculates total resource count efficiently without allocating arrays.
 * Handles cases where resources is already a number (hidden hand).
 * @param {Object|number} resources The resources object or a number
 * @returns {number} The total count of all resources
 */
export function getTotalResources(resources) {
  if (!resources || typeof resources === 'number') return resources || 0;
