...
/**
 * Calculates the total number of resources in a given resource object.
 * This is a highly optimized version that avoids array allocation and callback overhead.
 * @param {Object} resources - The resource object to count (sparse schema with brick, lumber, wool, grain, ore)
 * @returns {number} The total count of all resources
 */
